...
See for more details: [Quantum AI Study Group](https://nlp-lab.org/quantumnlp/)
...
The purpose of this repo and material is to share and promote educational material and examples for Quantum Algorithms and Computing, focusing on Machine Learning, Natural Language Processing, and AI.
...
- Qiskit 2.x material
- IBM Quantum course 'Basics of quantum information'



## Literature

-  Elías F. Combarro and Samuel González-Castillo (2025) *A Practical Guide to Quantum Computing: Hands-on approach to quantum computing with Qiskit*. Packt Publishing.
...
- The [IBM Quantum](https://www.ibm.com/quantum) and [Quantum Information Software Kit (QISKit)](https://qiskit.org/)
- The [Microsoft Quantum Computing pages](https://www.microsoft.com/en-us/quantum/) (Windows, macOS, Linux)
